...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        // TODO (5) Store an address in a String geo:0,0?q=1600 Amphitheatre Parkway, CA
        String uriAddress = "1600 Amphitheatre Parkway, CA";
    ...
    public void showMap (Uri geoUriLocation)
    {
        ...
        newIntent.setData(geoUriLocation);
